...
export const IntegrationsView =() =>{
    ...
    const handleCopy = async () => {
        ...
        try{
            ...
            toast.success("Copied to cllipboard");
        }catch{
                       ...
                       <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="group relative">
                                <pre className="max-h-[300-px] overflow-x-auto overflow-y-auto whitespace-pre-wrap break-all rounded-md bg-foreground p-2 font-mono text-secondary text-sm">
                                    {snippet}
