...
export const IntegrationsView = () => {
  ...
  // 🆕 added handler for widget navigation
  const handleGoToWidget = () => {
    if (!organization?.id) {
      toast.error("Organization ID not found");
      return;
    }
    const widgetUrl = `https://echo-widget-nine.vercel.app/?organizationId=${organization.id}`;
      ...
      <div className="flex min-h-screen flex-col bg-muted p-8">
        <div className="mx-auto w-full max-w-screen-md">
          ...
          <div className="mt-8 space-y-6">
            ...
            {/* 🆕 Added Go To Widget Button */}
           {organization?.id && (
  <Button
    variant="outline"
    className="gap-2"
    size="sm"
    onClick={handleGoToWidget}
  >
